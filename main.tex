...
\ea Czech (nominative context) \label{zoha:ex:phrases}
    \ea \gll kus \minsp{[} \textit{broskv-e}]\\
piece.\textsc{nom} {} peach.\textsc{f}-\textsc{gen.sg}\\
    ...
    \ex \gll dvě \minsp{[} \textit{broskv-e}]\\
    ...
    \ex \gll pět \minsp{[} \textit{broskv-iː}]\\
